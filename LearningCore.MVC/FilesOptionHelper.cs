...
{
    public class FilesOptionHelper
    {
        #region 扩展
        ...
        /*
           ...
           如果您需要检查IsValidFileExtensionAndSignature中的特定字符方法，在_allowedChars字段中提供字符。
         */
        ...
        // app.
        /*
         在大多数生产场景中，都有一个反病毒/反恶意软件扫描程序API
         在将文件提供给用户或其他用户之前对该文件使用
         系统。有关更多信息，请参见本示例附带的主题
         应用程序。
             */
